...
public class invalidSignup extends Base_Class {
    ...
    public Object[][] getTestData() {
        ...
        return JsonReader.getJSONData(jsonFilePath, "invalidSignupData");
    }


    @Test(dataProvider = "invalidSignupData")
    public void testLoginScenarios(String testCase, String username, String email, String password, String expectedResult) {
        ...
        WebElement usernameField = wait.until(ExpectedConditions.presenceOfElementLocated(
                AppiumBy.androidUIAutomator("new UiSelector().text(\"Jane Doe\")")));
        usernameField.clear();
